...
- ⚠️ **Pi 4 has leftover setup from a previous project** — must be wiped and reinstalled (fresh Pi OS Lite image) as part of Weekend 1. No carry-over config or services.

**Starting cost: ~£463 with the PicoMuon (already purchased).**
